...
#define _SuperTrak_VERSION 0.63.4
#endif
...
_BUR_PUBLIC ArEventLogRecordIDType SuperTrakLegacyLogWrite(unsigned char severity, unsigned long errornr, plcstring* message);
